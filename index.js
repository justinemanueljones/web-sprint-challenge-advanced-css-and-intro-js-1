...
const artist = artists.find(item => item.id == 0);              
console.log(artist.name);


/*(2) Bio of the third artist (2nd index) in the array */

const artist = artists.find(item => item.id == 2);
...
console.log(addArtist(20,"Justin JOnes","1995-2020","Web Dev", "African American", "Im ready for the weekend"))
//   (1) artists array 
